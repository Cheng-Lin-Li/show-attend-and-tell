...
class COCO:
    def __init__(self, annotation_file=None, max_ann_num=None):
        """
        Constructor of Microsoft COCO helper class for reading and visualizing annotations.
        :param annotation_file (str): location of annotation file
        :param max_ann_num (int): max. number of annotations to prepare
        ...
        if not annotation_file == None:
            ...
            self.createIndex(max_ann_num)

    def createIndex(self, max_ann_num = None):
        # create index
        ...
        if 'annotations' in self.dataset:
            if max_ann_num is None:
                ...
                imgToAnns = {ann['image_id']: [] for ann in islice(self.dataset['annotations'], 0, max_ann_num)}
                anns =      {ann['id']:       [] for ann in islice(self.dataset['annotations'], 0, max_ann_num)}
                for ann in islice(self.dataset['annotations'], 0, max_ann_num):
                    imgToAnns[ann['image_id']] += [ann]
                    anns[ann['id']] = ann
